			...
			<div class="crumb-wrap">
				<div class="crumb-list">
					<i class="icon-font"></i> <a href="admin.jsp">首页</a> <span
						class="crumb-step">&gt;</span> <a href="adminManagement.jsp"><span
						class="crumb-name">用户信息管理</span></a>
				</div>
			</div>
					...
					<div class="result-content">
						<table class="result-tab" width="100%">
							...
							<%
								...
								String sql = "select * from userlogin;"; //查询语句
							...
							<tr>
								...
								<td align="center">
								<a class="link-del" href="../DeleteUser?user=<%=rs.getString("username")%>">删除</a>
								</td>
							</tr>
							<%
								}
